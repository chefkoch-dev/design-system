...
<Meta title="Library/List Item View/Recipe List" 
  argTypes={{
...
export const Template = ({ headline, note, ...args }) => {
  return `
    <div class="ds-container">
      <div class="ds-grid ds-row">
        <div class="ds-col-12">
          <div class="ds-list-view-item ds-list-view-item--recipe">
            <a class="ds-list-view-item__link ds-teaser-link" href="#" title="Der beste Pizzateig">
              ...
              <div class="ds-list-view-item__body">
                <div class="ds-list-view-item__column ds-list-view-item__column--info">
                  <h4 class="ds-teaser-link__headline ds-list-view-item__headline ds-h4 ds-text-sans ds-trunc ds-trunc-2">${headline}</h4>
...
<Canvas>
  <Story name="Recipe List Item" args={{
    ...
    note: 'Nach unzähligen Feldversuchen, reichlich Google-Recherche und Restaurant-Spionage habe ich endlich ein Rezept entwickelt, das absolut authentisch und lecker schmeckt - eben wie in Bella Italia!'
  }}>
    {Template.bind({})}
  </Story>
</Canvas>